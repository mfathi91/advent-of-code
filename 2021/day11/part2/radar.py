...
class Radar:
    ...
    def next_step(self):
        before_step_num_flashed = self.get_num_flashes()
        ...
        after_step_num_flashed = self.get_num_flashes()
        return True if after_step_num_flashed - before_step_num_flashed == len(self.octopus_map) else False
