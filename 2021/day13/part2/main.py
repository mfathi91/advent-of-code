...
def draw_paper(paper: Set[Tuple]):
    max_x = 0
    max_y = 0
    for dot in paper:
...
def main():
    ...
    with open(input_file) as f:
        ...
        for fold_instruction in parse_fold_instructions(lines):
            paper = fold(paper, fold_instruction[0], fold_instruction[1])

        draw_paper(paper)    # CJCKBAPB
